...
```
cd existing_repo
git remote add origin https://git.geomar.de/shubhangi-gupta/spontaneousgasevolution.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.geomar.de/shubhangi-gupta/spontaneousgasevolution/-/settings/integrations)
